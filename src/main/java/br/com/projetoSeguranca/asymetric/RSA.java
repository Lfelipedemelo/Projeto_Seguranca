package br.com.projetoSeguranca.asymetric;
...
public class RSA {
  ...
  public static String generateKey(String login) {
    try {
        ...
        File privateKeyFile = new File(PATH_PRIVATE_KEY + login + ".key");
        File publickeyFile = new File(PATH_PUBLIC_KEY + login + ".key");
    ...
    return PATH_PUBLIC_KEY + login + ".key";
  }
